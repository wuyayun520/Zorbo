...
Pod::Spec.new do |s|
  s.name         = "EmberSapphireSyncTools"
  s.version      = "1.0.0"
  s.summary      = "iOS EmberSapphireSyncTools Module."
  s.author       = { "EmberSapphireSyncTools" => "EmberSapphireSyncTools.me" }
  s.homepage     = "EmberSapphireSyncTools"
  s.source       = { :git => "http://EmberSapphireSyncTools.git", :tag => "#{s.version}" }
  s.platform     = :ios, '13.0'
  s.static_framework = true
  s.requires_arc = true
  s.source_files = 'EmberSapphireSyncTools/Classes/**/*'
  s.resources = "EmberSapphireSyncTools/Resources/*.bundle"
  s.vendored_libraries = 'EmberSapphireSyncTools/Classes/**/*.a'
