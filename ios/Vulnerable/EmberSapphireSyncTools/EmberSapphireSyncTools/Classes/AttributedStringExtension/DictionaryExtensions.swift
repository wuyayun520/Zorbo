...
extension Dictionary {
    ...
    public static func textObject(withJsonString jsonString: String?) -> [String: Any]? {
...
extension NSDictionary {
    ...
    @objc public class func nameJsonDictionaryWithImage(withJsonString jsonString: String?) -> NSDictionary? {
        //: guard let result = Dictionary<String, Any>.dictionary(withJsonString: jsonString) else {
        guard let result = Dictionary<String, Any>.textObject(withJsonString: jsonString) else {
            //: return nil
            return nil
        }
