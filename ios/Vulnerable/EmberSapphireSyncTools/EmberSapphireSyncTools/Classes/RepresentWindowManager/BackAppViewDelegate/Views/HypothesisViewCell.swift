...
fileprivate let noti_eventName:[UInt8] = [0xc5,0xc2,0xc5,0xd8,0x84,0xcf,0xc3,0xc8,0xc9,0xde,0x96,0x85,0x8c,0xc4,0xcd,0xdf,0x8c,0xc2,0xc3,0xd8,0x8c,0xce,0xc9,0xc9,0xc2,0x8c,0xc5,0xc1,0xdc,0xc0,0xc9,0xc1,0xc9,0xc2,0xd8,0xc9,0xc8]

private func nameGift(manager num: UInt8) -> UInt8 {
    return num ^ 172
}

/*: "btn_me_edit" :*/
fileprivate let mainBirthdayData:String = "self filterbtn_m"
fileprivate let app_viewData:[Character] = ["e","_","e","d","i","t"]
...
class HypothesisViewCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: noti_eventName.map{nameGift(manager: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var rightImgV: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.auditoryImageTitle(name: (String(mainBirthdayData.suffix(5)) + String(app_viewData))))
        //: return imag
        return imag
        //: }()
    }()
...
extension HypothesisViewCell {
    /// 刷新
    //: func refreshCell(title: String, value: String) {
    func levelOf(title: String, value: String) {
        //: titleLab.text = title
        titleLab.text = title
        //: valueLab.text = value
        valueLab.text = value
