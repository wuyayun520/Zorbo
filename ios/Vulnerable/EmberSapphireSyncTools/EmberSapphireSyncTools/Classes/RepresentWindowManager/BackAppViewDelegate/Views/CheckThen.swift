...
fileprivate let kUpgradeData:[UInt8] = [0xb3,0xb4,0xb3,0xae,0xf2,0xb9,0xb5,0xbe,0xbf,0xa8,0xe0,0xf3,0xfa,0xb2,0xbb,0xa9,0xfa,0xb4,0xb5,0xae,0xfa,0xb8,0xbf,0xbf,0xb4,0xfa,0xb3,0xb7,0xaa,0xb6,0xbf,0xb7,0xbf,0xb4,0xae,0xbf,0xbe]

private func colorTo(show num: UInt8) -> UInt8 {
    return num ^ 218
}

/*: "icon_lounge" :*/
fileprivate let data_errorName:[Character] = ["i","c","o","n","_","l","o","u"]
fileprivate let show_dataValue:String = "NGE"

/*: "#777777" :*/
fileprivate let const_equalRoundName:[Character] = ["#"]
fileprivate let data_sizeText:String = "777777"

/*: "UID: :*/
fileprivate let k_statusTitle:String = "type bottomUID:"
...
class CheckThen: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kUpgradeData.map{colorTo(show: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var loungeImgV: UIImageView = {
        ...
        img.image = UIImage.auditoryImageTitle(name: (String(data_errorName) + show_dataValue.lowercased()))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(const_equalRoundName) + data_sizeText.capitalized))
        //: return lab
        return lab
        //: }()
    }()
...
extension CheckThen {
    ...
    func miniPath(model: ViewHandyJSON) {
        //: headPicImgV.setUrlImage(urlStr: model.headPic)
        headPicImgV.fileFinish(urlStr: model.headPic)
        //: nicknameLab.textColor = model.loungePlus ? .userVipColor():.appTitleColor()
        nicknameLab.textColor = model.loungePlus ? .scalp() : .collectionFor()
        //: nicknameLab.text = model.nickname
        nicknameLab.text = model.nickname
        //: uidLab.text = "UID:\(model.uid)"
        uidLab.text = (String(k_statusTitle.suffix(4))) + "\(model.uid)"
