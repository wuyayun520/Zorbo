...
fileprivate let main_reValue:[UInt8] = [0x91,0x96,0x91,0x8c,0xd0,0x9b,0x97,0x9c,0x9d,0x8a,0xc2,0xd1,0xd8,0x90,0x99,0x8b,0xd8,0x96,0x97,0x8c,0xd8,0x9a,0x9d,0x9d,0x96,0xd8,0x91,0x95,0x88,0x94,0x9d,0x95,0x9d,0x96,0x8c,0x9d,0x9c]

private func sawLog(status num: UInt8) -> UInt8 {
    return num ^ 248
}

/*: "icon_rank_coin" :*/
fileprivate let dataContentText:[UInt8] = [0x32,0x38,0x34,0x35,0x4,0x29,0x3a,0x35,0x30,0x4,0x38,0x34,0x32,0x35]

/*: "icon_lounge" :*/
fileprivate let const_toName:[Character] = ["i","c","o","n","_","l","o","u","n"]
fileprivate let noti_topData:String = "hiddene"

/*: "icon_rank_coin2" :*/
fileprivate let k_makeText:[Character] = ["i","c","o","n","_","r","a","n","k","_","c","o","i","n"]
fileprivate let mainTableText:String = "2"
...
class InfoViewCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: main_reValue.map{sawLog(status: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var rankLabel = UILabel().then {
        ...
        $0.textColor = UIColor.effectColor()
        //: $0.font = .pingfangFont(type: .Semibold, fontSize: 20)
        $0.font = .handleFont(type: .Semibold, fontSize: 20)
    }
    ...
    lazy var coinIconBtn = IndexStopView().then {
        //: $0.setImage(UIImage.BundleImageNamed(name: "icon_rank_coin"), for: .normal)
        $0.setImage(UIImage.auditoryImageTitle(name: String(bytes: dataContentText.map{$0^91}, encoding: .utf8)!), for: .normal)
        //: $0.setTitleColor(UIColor.white, for: .normal)
        $0.setTitleColor(UIColor.white, for: .normal)
        //: $0.titleLabel?.font = .pingfangFont(type: .Medium, fontSize: 15)
        $0.titleLabel?.font = .handleFont(type: .Medium, fontSize: 15)
        ...
        $0.setBackgroundImage(UIImage.colored(colors: UIColor.tableColor(), size: CGSize(width: actualWidth(w: 80), height: actualWidth(w: 33))), for: .normal)
    ...
    lazy var loungeImgV = UIImageView().then {
        ...
        $0.image = UIImage.auditoryImageTitle(name: (String(const_toName) + noti_topData.replacingOccurrences(of: "hidden", with: "g")))
    }
}
...
extension InfoViewCell {
    ...
    func voiceNow(model: ContainerModelType, index: Int) {
        ...
        headPic.fileFinish(urlStr: model.headPic)
    ...
    func theme(type: Int) {
        ...
        let imageStr = type == 0 ? String(bytes: dataContentText.map{$0^91}, encoding: .utf8)! : (String(k_makeText) + mainTableText.capitalized)
        //: coinIconBtn.setImage(UIImage.BundleImageNamed(name: imageStr), for: .normal)
        coinIconBtn.setImage(UIImage.auditoryImageTitle(name: imageStr), for: .normal)
    }
}
