...
/*: "&sr=6" :*/
fileprivate let mainJumpBeautyData:String = "path make list&sr=6"
...
enum CurrentColumnConvertible: String, CaseIterable {
...
class AllManager: NSObject {
    //: class func getFullUrl(urlType: WebUrlType)-> String {
    class func contextShow(urlType: FrontMeasurable) -> String {
        //: var url = SceneAppManager.share.appConfigMode.urlH5Domain
        var url = SceneAppManager.share.appConfigMode.urlH5Domain
        //: switch urlType {
        switch urlType {
        //: case .RechargeFullPage:
        case .RechargeFullPage:
            //: url.append(SceneAppManager.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : SceneAppManager.share.appUserConfigMode.fullRechargePage)
            url.append(SceneAppManager.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : SceneAppManager.share.appUserConfigMode.fullRechargePage)

        //: break
        //: case .RechargeHalfPage:
        case .RechargeHalfPage:
            //: url.append(SceneAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : SceneAppManager.share.appUserConfigMode.halfRechargePage)
            url.append(SceneAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : SceneAppManager.share.appUserConfigMode.halfRechargePage)

        //: case .RechargeToVideoInitivHalfPage:
        case .RechargeToVideoInitivHalfPage:
            //: let newstr = SceneAppManager.share.appUserConfigMode.halfRechargePage.appending("&sr=6")
            let newstr = SceneAppManager.share.appUserConfigMode.halfRechargePage.appending((String(mainJumpBeautyData.suffix(5))))
            //: url.append(SceneAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
            url.append(SceneAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
        //: default:
        default:
