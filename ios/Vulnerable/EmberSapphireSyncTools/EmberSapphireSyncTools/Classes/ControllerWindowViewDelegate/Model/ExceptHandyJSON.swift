...
class ExceptHandyJSON: HandyJSON {
    //: var roomId = ""                           // trtc房间号
    var roomId = "" // trtc房间号
    //: var streamerInfo = TalkingStreamerInfo()
    var streamerInfo = SumervalModelType() // 主播信息
    //: var livePlayUrl = ""                      // CDN旁路直播拉流地址
    var livePlayUrl = "" // CDN旁路直播拉流地址
    //: var gameList = [TalkingGameListModel]()
    var gameList = [PlayerListModel]() // 游戏列表
...
class SumervalModelType: HandyJSON {
    //: var uid = 0
    var uid = 0
    //: var headPic = ""
    var headPic = ""
...
class PlayerListModel: HandyJSON {
    //: var name = ""
    var name = ""
    //: var icon = ""
    var icon = ""
