...
/// 性别
//: enum Gender: String {
enum WithSchemaConvertible: String {
    //: case unknown = "0"
    case unknown = "0"
    //: case male    = "1"
    case male = "1"
...
enum ShouldDefaultsSerializable: String {
    //: case unknown = "0"        // 未开始
    case unknown = "0" // 未开始
...
enum DemonstrateInsetTarget: Int {
    //: case unknown    = 0
    case unknown = 0
    //: case social     = 1
    case social = 1 // 社交礼物
...
@objc enum HighStatusValueConvertible: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum WithCreateRepresentable: Int {
    //: case Unavailable = 0
...
enum IndexCaseIterable: CaseIterable {
