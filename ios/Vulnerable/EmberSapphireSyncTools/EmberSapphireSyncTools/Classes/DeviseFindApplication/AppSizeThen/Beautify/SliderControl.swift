...
/*: "st_slider_thumb" :*/
fileprivate let data_viewEnableText:[Character] = ["s","t","_","s","l","i"]
fileprivate let main_fatalShowData:String = "der_tname model"

/*: "init(coder:) has not been implemented" :*/
fileprivate let showPathTextData:[UInt8] = [0x23,0x24,0x23,0x3e,0x62,0x29,0x25,0x2e,0x2f,0x38,0x70,0x63,0x6a,0x22,0x2b,0x39,0x6a,0x24,0x25,0x3e,0x6a,0x28,0x2f,0x2f,0x24,0x6a,0x23,0x27,0x3a,0x26,0x2f,0x27,0x2f,0x24,0x3e,0x2f,0x2e]

private func makeName(size num: UInt8) -> UInt8 {
    return num ^ 74
}
...
class SliderControl: UISlider {
    ...
    override var currentThumbImage: UIImage? {
        ...
        get {
            ...
            return UIImage.auditoryImageTitle(name: (String(data_viewEnableText) + String(main_fatalShowData.prefix(5)) + "humb"))
        }
        //: set {
        set {}
    }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: showPathTextData.map{makeName(size: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var valueView: UIButton = {
        ...
        btn.titleLabel?.font = UIFont.handleFont(type: .Regular, fontSize: 12)
...
extension SliderControl {
    ...
    func modelDownValue(value: Float) {
