...
// __CLOSE_PRINT__
//
//  AttentionEntiretycostModel.swift
//  AbroadTalking
//
...
//: @objcMembers public class AttentionEntiretycostModel: JSONModel {
@objcMembers public class AttentionEntiretycostModel: JSONModel {
    //: public var beautySuite =  BeautyItemType.Face
    public var beautySuite = DayPriorityTarget.Face
...
//: @objc extension AttentionEntiretycostModel {
@objc extension AttentionEntiretycostModel {
    //: func initWith(suiteType: BeautyItemType)-> AttentionEntiretycostModel {
    func productOnFilter(suiteType: DayPriorityTarget) -> AttentionEntiretycostModel {
        //: let model = AttentionEntiretycostModel.init()
        let model = AttentionEntiretycostModel()
