...
/*: "id" :*/
fileprivate let show_miniValue:[Character] = ["i","d"]
...
struct AppSceneInfoModel: HandyJSON {
    //: var uid: String = ""
    var uid: String = ""
    ...
    var momentPic: ButtonMeasurable?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [ChemicalElementMeasurable]? // 相册
    ...
    var aiExtraInfo = EventModelType() // AI模型
    //: var vipSkinId = 0
...
struct ButtonMeasurable: HandyJSON {
    //: var count: Int = 0
    var count: Int = 0
    //: var list: Array<TalkingUserInfoMomentItemModel>?
    var list: [MomentHandyJSON]?
}
...
struct ChemicalElementMeasurable: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func tantamount(compareTo: ChemicalElementMeasurable) -> Bool {
        //: return
        return
...
struct EventModelType: HandyJSON {
    //: var height = 0
    var height = 0 // 身高
    //: var weight = 0
    var weight = 0 // 体重
