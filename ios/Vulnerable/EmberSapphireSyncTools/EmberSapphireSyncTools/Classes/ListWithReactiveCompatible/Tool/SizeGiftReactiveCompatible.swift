...
/*: "detection" :*/
fileprivate let kObjectName:String = "appetect"
fileprivate let app_pathTitle:String = "ioshared"

/*: "aiff" :*/
fileprivate let userAddTitle:String = "aiblueblue"
...
// __CLOSE_PRINT__
//
//  SizeGiftReactiveCompatible.swift
...
class SizeGiftReactiveCompatible: NSObject {
    // singleton
    //: static let shared = RBDMuteSwitch()
    static let shared = SizeGiftReactiveCompatible()
    ...
    func cellPauseWarning() {
        //: soundDuration = 0.0
        soundDuration = 0.0
        //: let soundFilePath = SVGAEffectTool.default.getMp3Path(name: "detection", type: "aiff")
        let soundFilePath = PlaceImpactEffectTool.default.variationType(name: (kObjectName.replacingOccurrences(of: "app", with: "d") + app_pathTitle.replacingOccurrences(of: "shared", with: "n")), type: (userAddTitle.replacingOccurrences(of: "blue", with: "f")))
        ...
        let soundCompletionCallback: AudioServicesSystemSoundCompletionProc = { soundID, _ in
            ...
            SizeGiftReactiveCompatible.shared.colorWith()
        }
