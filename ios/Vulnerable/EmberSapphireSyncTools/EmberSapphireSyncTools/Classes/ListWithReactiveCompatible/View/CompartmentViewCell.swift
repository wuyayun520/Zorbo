...
fileprivate let mainWhiteValue:[UInt8] = [0x19,0x1e,0x19,0x4,0x58,0x13,0x1f,0x14,0x15,0x2,0x4a,0x59,0x50,0x18,0x11,0x3,0x50,0x1e,0x1f,0x4,0x50,0x12,0x15,0x15,0x1e,0x50,0x19,0x1d,0x0,0x1c,0x15,0x1d,0x15,0x1e,0x4,0x15,0x14]

private func equalStyle(lab num: UInt8) -> UInt8 {
    return num ^ 112
}

/*: "Add" :*/
fileprivate let show_toAppData:String = "Addinfo white"

/*: "btn_me_edit" :*/
fileprivate let showCellValue:String = "btn_mshare view front"

/*: "Program" :*/
fileprivate let app_mentionName:[Character] = ["P","r","o","g","r","a","m"]
...
class CompartmentViewCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: mainWhiteValue.map{equalStyle(lab: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var tipsLab: UILabel = {
        ...
        lb.text = (String(show_toAppData.prefix(3))).localized
        //: return lb
        return lb
        //: }()
    }()
    ...
    private lazy var editImg: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.auditoryImageTitle(name: (String(showCellValue.prefix(5)) + "e_edit")))
        //: imag.isUserInteractionEnabled = false
        imag.isUserInteractionEnabled = false
        //: return imag
        return imag
...
extension CompartmentViewCell {
    ...
    func panAdd(title: String, icon: String) {
        //: iconImg.image = UIImage.BundleImageNamed(name: icon)
        iconImg.image = UIImage.auditoryImageTitle(name: icon)
        //: titleLab.text = title.localized
        titleLab.text = title.localized
        //: if title == "Program" {
        if title == (String(app_mentionName)) {
    ...
    func logDelete(isHidden: Bool) {
        //: tipsLab.isHidden = isHidden
        tipsLab.isHidden = isHidden
    }

    //: func setArrow() {
    func displaceUpShaftEdit() {
        ...
        backBtn.keyRadii(width: main_clickBottomContent - 30, height: 50, corners: [.topLeft, .topRight], cornerRadii: .init(width: 8, height: 8))
    }
}
