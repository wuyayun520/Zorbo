...
@property (nonatomic, strong)MailModel *user;

//: @property (nonatomic, strong)AbTalkingChatMsgToUserModel *toUser;
@property (nonatomic, strong)BallToModel *toUser;

//: @property (nonatomic, strong)AbTalkingChatMsgGiftModel *gift;
@property (nonatomic, strong)DataModel *gift;

//: @property (nonatomic, strong)AbTalkingChatMsgTipsModel *tips;
@property (nonatomic, strong)ToModel *tips;

//: @property (nonatomic, strong)AbTalkingChatMsgQuoteModel *quoteMsgInfo;
@property (nonatomic, strong)ParcelModel *quoteMsgInfo;

//: @property (nonatomic, strong)ProductTransformable *userInfoModel;
@property (nonatomic, strong)ProductTransformable *userInfoModel;
...
@property (nonatomic, strong) EqualValueModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) AbTalkingChatMsgVideoModel *video; 
@property (nonatomic, strong) SoundMakeModel *video; /// 有该字段表示是视频消息
//: @property (nonatomic, strong) AbTalkingChatMsgCustomSendModel *customSend; 
@property (nonatomic, strong) SizeModel *customSend; /// 保存自定义发送字段（用于失败重发）

//: @property (nonatomic, strong) WantGiftModel *wantGift; 
@property (nonatomic, strong) PlayUserModel *wantGift; /// 想要礼物
...
@interface EqualValueModel : JSONModel
...
+ (void)saveIntimatePhoto:(EqualValueModel *)photoModel forMsgID:(NSString *)msgID;
...
@interface SoundMakeModel: JSONModel
...
+ (void)saveIntimateVideo:(SoundMakeModel *)videoModel forMsgID:(NSString *)msgID;
...
@interface BallToModel : JSONModel
...
@interface PlayUserModel : JSONModel
...
@interface ParcelModel : JSONModel
...
@property (nonatomic, strong) BlockModel *renderData;
