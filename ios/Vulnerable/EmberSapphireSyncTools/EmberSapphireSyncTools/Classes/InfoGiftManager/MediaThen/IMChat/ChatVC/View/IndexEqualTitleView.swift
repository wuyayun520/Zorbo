...
fileprivate let constRedContent:[UInt8] = [0xa1,0xa6,0xa1,0xbc,0xe0,0xab,0xa7,0xac,0xad,0xba,0xf2,0xe1,0xe8,0xa0,0xa9,0xbb,0xe8,0xa6,0xa7,0xbc,0xe8,0xaa,0xad,0xad,0xa6,0xe8,0xa1,0xa5,0xb8,0xa4,0xad,0xa5,0xad,0xa6,0xbc,0xad,0xac]

private func ageReturn(background num: UInt8) -> UInt8 {
    return num ^ 200
}

/*: "nav_back_black_nor" :*/
fileprivate let notiLabContent:[Character] = ["n","a","v","_","b","a","c","k","_","b","l","a","c","k","_","n","o","r"]

/*: "btn_detail_more" :*/
fileprivate let user_buttonData:String = "image string selfbtn_d"
fileprivate let showPageValue:String = "to view_more"

/*: "btn_chat_videocall" :*/
fileprivate let const_intimateName:[Character] = ["b","t","n","_","c","h","a"]
fileprivate let mainSafetyTitle:String = "model stage size fail lett_"
fileprivate let dataTitleName:[Character] = ["v","i","d","e","o","c","a","l","l"]

/*: "icon_lounge" :*/
fileprivate let k_imageData:String = "icorequest"
fileprivate let appMakeTitle:String = "gcenter"

/*: "Official" :*/
fileprivate let userManagerText:[Character] = ["O","f","f","i","c","i","a","l"]

/*: "Online List" :*/
fileprivate let app_scaleData:[Character] = ["O","n","l","i","n","e"," ","L"]
fileprivate let data_infoValue:String = "IST"

/*: "icon_privateChat_intimate" :*/
fileprivate let mainCenterData:String = "icosource"
fileprivate let data_positionValue:String = "input if collection left partyteChat"
fileprivate let notiTimeName:[Character] = ["_","i","n","t"]
fileprivate let kPlusExitTitle:String = "imneedte"

/*: "#FF60B9" :*/
fileprivate let showGiftSectionInviteValue:[Character] = ["#"]
fileprivate let mainByValue:[Character] = ["F","F","6","0","B","9"]

/*: "Customer Care Center" :*/
fileprivate let userEqualAgentData:[Character] = ["C","u","s","t","o","m","e","r"," ","C","a","r","e"," ","C","e"]
fileprivate let kEmptyName:String = "ntwhiter"

/*: "#48FF1E" :*/
fileprivate let k_modeTimeName:String = "leading window view#48FF1E"

/*: "Online" :*/
fileprivate let main_eventData:String = "if row self buttonOnline"

/*: "#FF4B7F" :*/
fileprivate let userPopEqualSuperName:[Character] = ["#","F","F","4","B","7","F"]

/*: "busy" :*/
fileprivate let k_frameNetworkValue:String = "BUSY"

/*: "+ :*/
fileprivate let const_imageData:String = "+"

/*: "get json error" :*/
fileprivate let appResultBeginViewName:String = "get jsview table shared self"
fileprivate let show_tableSourceText:[Character] = ["o","n"," ","e","r","r","o","r"]

/*: "transform.rotation" :*/
fileprivate let data_fillWrapName:[Character] = ["t","r","a","n","s","f","o","r","m",".","r","o"]
fileprivate let k_userRowName:String = "tatiosize"

/*: "transform.scale" :*/
fileprivate let constViewData:String = "thideans"
fileprivate let user_systemValue:[Character] = [".","s","c","a","l","e"]

/*: "zoom&shake" :*/
fileprivate let userAddKeyContent:String = "zoom&size insert green collection point"
fileprivate let kStandardName:String = "shakinfo"
...
class IndexEqualTitleView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: constRedContent.map{ageReturn(background: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var backButton: UIButton = {
        ...
        let img = UIImage.auditoryImageTitle(name: (String(notiLabContent))).withRenderingMode(.alwaysTemplate)
    ...
    lazy var moreButton: UIButton = {
        ...
        let img = UIImage.auditoryImageTitle(name: (String(user_buttonData.suffix(5)) + "etail" + String(showPageValue.suffix(5)))).withRenderingMode(.alwaysTemplate)
        //: btn.setImage(img, for: .normal)
        btn.setImage(img, for: .normal)
        //: btn.tintColor = .white
        btn.tintColor = .white
    ...
    lazy var videoCallBtn: UIButton = {
        ...
        let img = UIImage.auditoryImageTitle(name: (String(const_intimateName) + String(mainSafetyTitle.suffix(2)) + String(dataTitleName))).withRenderingMode(.alwaysTemplate)
        //: btn.setImage(img, for: .normal)
        btn.setImage(img, for: .normal)
        //: btn.tintColor = .white
        btn.tintColor = .white
    ...
    lazy var loungeImgV: UIImageView = {
        ...
        img.image = UIImage.auditoryImageTitle(name: (k_imageData.replacingOccurrences(of: "request", with: "n") + "_loun" + appMakeTitle.replacingOccurrences(of: "center", with: "e")))
        //: img.isHidden = true
        img.isHidden = true
        //: return img
        return img
    ...
    lazy var officalImgV: UIButton = {
        ...
        img.setTitle((String(userManagerText)).localized, for: .normal)
    ...
    lazy var onlineListBtn: UIButton = {
        ...
        btn.setTitle((String(app_scaleData) + data_infoValue.lowercased()).localized, for: .normal)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var onlineStatusV: IndexStopView = {
    ...
    private lazy var myBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(construct), for: .touchUpInside)
    ...
    private lazy var intimateBtn: UIButton = {
        ...
        btn.setImage(UIImage.auditoryImageTitle(name: (mainCenterData.replacingOccurrences(of: "source", with: "n") + "_priva" + String(data_positionValue.suffix(6)) + String(notiTimeName) + kPlusExitTitle.replacingOccurrences(of: "need", with: "a"))), for: .normal)
        //: btn.isHidden = true
        btn.isHidden = true
        //: btn.addTarget(self, action: #selector(intimateBtnClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(toDisable), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var intimateLB: UILabel = {
        ...
        lb.textColor = UIColor(hex: (String(showGiftSectionInviteValue) + String(mainByValue)))
    ...
    private lazy var addIntimateLB: UILabel = {
        ...
        lb.font = UIFont.handleFont(type: .Semibold, fontSize: 12)
        //: lb.isHidden = true
        lb.isHidden = true
...
extension IndexEqualTitleView {
    ...
    func onViews() {
        ...
        if self.chatType == .service {
            ...
            titleLabel.text = (String(userEqualAgentData) + kEmptyName.replacingOccurrences(of: "white", with: "e")).localized
            //: titleLabel.font = .pingfangFont(type: .Medium, fontSize: 18)
            titleLabel.font = .handleFont(type: .Medium, fontSize: 18)
            //: titleLabel.textColor = .appTitleColor()
            titleLabel.textColor = .collectionFor()
    ...
    func countSubName() {
        ...
        if self.chatType == .service { // 官方客服
            ...
            let offset = CalendarThen.shared.direction == .leftToRight ? 22 : -22
    ...
    ///   - userModel: 用户信息
    ///   - isFrom: 列表控制器入口
    //: func private_updateNavView(userModel: ProductTransformable, isFrom: PrivateChatIsFromEnum) {
    func quick(userModel: ProductTransformable, isFrom: RecordAlbumFromEnum) {
        ...
        if userModel.onlineStatus == 1 {
            ...
            let image = UIImage.atomicQuantity85(color: UIColor(hex: (String(k_modeTimeName.suffix(7))))!, size: CGSize(width: 8, height: 8))
            //: onlineStatusV.setImage(image.circle(), for: .normal)
            onlineStatusV.setImage(image.circle(), for: .normal)
            //: onlineStatusV.setTitle("Online".localized, for: .normal)
            onlineStatusV.setTitle((String(main_eventData.suffix(6))).localized, for: .normal)
            ...
            let image = UIImage.atomicQuantity85(color: UIColor(hex: (String(userPopEqualSuperName)))!, size: CGSize(width: 8, height: 8))
            //: onlineStatusV.setImage(image.circle(), for: .normal)
            onlineStatusV.setImage(image.circle(), for: .normal)
            //: onlineStatusV.setTitle("busy".localized, for: .normal)
            onlineStatusV.setTitle((k_frameNetworkValue.lowercased()).localized, for: .normal)
            //: } else {
        } else {
        ...
        titleLabel.textColor = userModel.loungePlus ? .scalp() : .white
        ...
        var videoCall = userModel.enableVideoCall
        //: if isFrom == .LiveRoom || SceneAppManager.share.appStatus == AppSkinStatus.special.rawValue {
        if isFrom == .LiveRoom || SceneAppManager.share.appStatus == HighStatusValueConvertible.special.rawValue {
            //: videoCall = false
            videoCall = false
        }
        //: if videoCall {
    ...
    /// - Parameters:
    ///   - userModel: 用户信息
    //: func private_updateIntimateNavView(userModel: ProductTransformable) {
    func artifact(userModel: ProductTransformable) {
        ...
        userBtn.isHidden = false
        //: myBtn.setUrlImage(urlStr: SceneAppManager.share.loginUserMode.headPic ?? "")
        myBtn.quantityerleave(urlStr: SceneAppManager.share.loginUserMode.headPic ?? "")
        //: userBtn.setUrlImage(urlStr: userModel.headPic)
        userBtn.quantityerleave(urlStr: userModel.headPic)
    ...
    func pickState(intimate: Int) {
        ...
        let attributes = [.foregroundColor: UIColor.white, .font: UIFont.handleFont(type: .Semibold, fontSize: 12)] as [NSAttributedString.Key: Any]
        ...
        let url = PlaceImpactEffectTool.default.knockEnableEffect(type: .Private_Chat_intimate)
        //: do {
        do {
            ...
            printLog(message: (String(appResultBeginViewName.prefix(6)) + String(show_tableSourceText)))
        }
    }
    ...
    @objc func construct() {
        //: AccumulationThen.share.func__pushToUserDetailVC(uid: SceneAppManager.share.loginUserMode.userID)
        AccumulationThen.share.character(uid: SceneAppManager.share.loginUserMode.userID)
    }

    //: @objc func userIconClick() {
    @objc func straddle() {
        //: AccumulationThen.share.func__pushToUserDetailVC(uid: userId)
        AccumulationThen.share.character(uid: userId)
    }
    ...
    @objc func toDisable() {
        ...
        let view = StigmatiseViewDelegate(frame: CGRect(x: 0, y: 0, width: main_clickBottomContent, height: data_senseEndMessage))
        //: view.show()
        view.duringView()
    }
    ...
    func aboveEventText() {
        ...
        let roate = CAKeyframeAnimation(keyPath: (String(data_fillWrapName) + k_userRowName.replacingOccurrences(of: "size", with: "n")))
        ...
        let zoom = CAKeyframeAnimation(keyPath: (constViewData.replacingOccurrences(of: "hide", with: "r") + "form" + String(user_systemValue)))
        ...
        videoCallBtn.layer.add(groupAnnimation, forKey: (String(userAddKeyContent.prefix(5)) + kStandardName.replacingOccurrences(of: "info", with: "e")))
    }
}
