...
@objc public enum FrontTranslateStatus: UInt {
...
@objc public enum MediaBackPropertyProtocol: UInt {
...
// MARK: - IndexEventCellData

/**
 * 【模块名称】IndexEventCellData
 ...
 */
//: @objcMembers public class IndexEventCellData: TCommonCellData {
@objcMembers public class IndexEventCellData: ViewButtonReactiveCompatible {
    ...
    public var direction: MediaBackPropertyProtocol = .MsgDirectionIncoming
    ...
    public var translateStatus: FrontTranslateStatus = .MsgTranslate_init
    ...
    public var msgModel: QuantityeractionModel = QuantityeractionModel()
    ...
    public var cellLayout: LayoutCompartmentMessageReactiveCompatible!
    ...
    public init(direction: MediaBackPropertyProtocol) {
        //: super.init()
        super.init()
        ...
        self.avatarImage = UIImage.squareThrow()
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.cellLayout = LayoutCompartmentMessageReactiveCompatible(isIncomming: true)
        ...
        //: } else {
            ...
            self.cellLayout = LayoutCompartmentMessageReactiveCompatible(isIncomming: false)
