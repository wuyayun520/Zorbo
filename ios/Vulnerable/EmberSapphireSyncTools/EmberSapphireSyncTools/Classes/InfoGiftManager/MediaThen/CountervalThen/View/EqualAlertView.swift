...
fileprivate let notiPathTitle:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_livetc_warn" :*/
fileprivate let k_designCollectionData:String = "manager playericon_"
fileprivate let noti_arrayData:[Character] = ["w","a","r","n"]

/*: "OK" :*/
fileprivate let data_managerName:String = "Ovalue"
...
class EqualAlertView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: notiPathTitle.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        iamg.image = UIImage.auditoryImageTitle(name: (String(k_designCollectionData.suffix(5)) + "livetc_" + String(noti_arrayData)))
    ...
    private lazy var contentLab: UILabel = {
        ...
        lab.textAlignment = .center
        //: lab.text = SceneAppManager.share.appUserConfigMode.blockCameraPopupContent
        lab.text = SceneAppManager.share.appUserConfigMode.blockCameraPopupContent
        //: lab.numberOfLines = 0
        lab.numberOfLines = 0
        //: return lab
    ...
    private lazy var closeBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(clickImage), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension EqualAlertView {
    ...
    //: @objc func dismiss() {
    @objc func toAGreaterExtentDismiss() {
        //: popView?.dismissView()
        popView?.ofUp()
        //: popView = nil
        popView = nil
...
extension EqualAlertView {
    ...
    private func setupEqualSubviews() {
