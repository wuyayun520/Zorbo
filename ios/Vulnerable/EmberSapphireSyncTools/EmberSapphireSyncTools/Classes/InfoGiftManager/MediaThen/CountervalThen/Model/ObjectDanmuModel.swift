...
let showReplaceFormat = actualWidth(w: 275)
//: let VideoMsgTableViewHeight =  actualWidth(w: 200)
let data_environmentStr = actualWidth(w: 200)
//: let VideocellLineSpeing = 3
let user_netKey = 3 /// cell间距

//: struct TalkingVideoCallDanmuModel: HandyJSON {
struct ObjectDanmuModel: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var senderUid = ""
    var senderUid = ""
